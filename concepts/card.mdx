...
Card Block is responsible for the mapping of the onboarded data and, if needed, enriching it further onboarding of any 3rd party data sources. This is where you define your onboarded data and end up with a unified dataset that can be used to power your new digital experiences.
