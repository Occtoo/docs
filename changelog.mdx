...
Source properties are now first-class objects: each can carry a data type, delimiter for list types, and display name — managed via new GraphQL queries and mutations. See [working with properties and data types](/guides/studio/properties-and-data-types).
