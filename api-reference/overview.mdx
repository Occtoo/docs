...
To ease any integration work we've created a NuGet package with an onboarding SDK. The package covers integrations of both data and media resources, and the code can be found on our [GitHub page](https://github.com/Occtoo/Occtoo.Onboarding.Sdk). The package is available via [nuget.org](https://www.nuget.org/packages/Occtoo.Onboarding.Sdk).
