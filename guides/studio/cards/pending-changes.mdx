...
The card then has status **Pending Changes**, and its status card reads "Uncommitted changes were made to this card's properties or relations. Activate the card to apply these changes."
...
**Pending changes** and **Pending delete** carry the tooltip "This property has uncommitted changes. Activate the card to apply them."
...
A row with a pending edit or a pending removal shows a revert button in place of the edit pencil. Pressing it drops that pending change and leaves the property as it is live, confirmed with "Property reverted successfully".
...
<Info>
  Activating needs the card activation permission. Without it the **Activate
