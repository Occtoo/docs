...
<Warning>
The date and time you pick is read in your local timezone and converted to UTC (+00:00) before the filter is applied. On a browser set to UTC+2, a boundary of 00:00 is sent as 22:00 the day before. Studio repeats this on the **In between (range)** option: "We'll use UTC (+00:00) timezone to filter the data".
</Warning>
