...
<Steps>
  ...
  <Step title="Press Update">
    ...
    **Update** stays disabled until you change something. Occtoo confirms with "Data provider updated successfully".
...
<Info>
The provider ID does not change when you rename a provider, so integrations keep working. Editing needs the data provider edit permission; without it the menu item is disabled.
</Info>
