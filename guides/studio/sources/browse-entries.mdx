...
A source with no entries shows **No entries** with an **Import data** button. CSV is the only format Studio imports; for anything else, contact support@occtoo.com.
