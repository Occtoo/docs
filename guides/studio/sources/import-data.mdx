...
Properties the source has not seen before are created automatically. Occtoo infers a type, which you can then correct, along with capabilities and interface settings — see [Add or edit a property](/guides/studio/sources/add-and-edit-a-property).
