...
Properties appear on their own the first time data arrives carrying them, whether through a provider or a CSV import. Defining one up front lets you set its type, capabilities and interface settings before any data lands — see [Add or edit a property](/guides/studio/sources/add-and-edit-a-property).
