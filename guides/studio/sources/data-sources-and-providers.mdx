...
Viewing sources needs the data source view permission. Creating and editing sources and their properties needs the data source edit permission, deleting and purging need the data source delete permission, and importing needs the data source import permission. The **Data providers** tab is only reachable with the data provider edit permission.

Where you lack a permission the control is disabled and its tooltip says so.
