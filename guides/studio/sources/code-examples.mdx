...
<Warning>
The dialog carries its own note: "do not include secrets in frontend JavaScript code or add to source control. Remove secrets that are no longer needed." If you paste the secret to generate the snippet, strip it before committing the code.
</Warning>
