...
![An image from the static](/images/guides/studio/Source_properties-546b07cdb61d938aa803283ce222fd5e.png)
...
- **Easier to evolve.** When the shape of your source data changes, you adjust the property on the source. Cards referencing it stay aligned.
...
Cards still control the parts that are specific to how a card uses a property:
...
For any new card, prefer referencing source properties rather than redefining types inline. Existing cards continue to work as before; you can migrate them to source-defined properties at your own pace.
