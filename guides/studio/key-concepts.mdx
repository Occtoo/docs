...
A standing instruction to push events to your own endpoint or queue as changes happen, instead of waiting for a system to ask. See [Find event subscriptions](/guides/studio/events/find-subscriptions).
